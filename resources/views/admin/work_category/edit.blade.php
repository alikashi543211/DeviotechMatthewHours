...
@section('nav-title', 'Edit Work Category')
@section('content')
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header card-header-primary">
                            <h4 class="card-title">Edit Work Category</h4>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="work_cateogry_block">
                                        <div class="shadow row" id="work_cat_row-1">
                                            <div class="col-md-6">
                                                <label>Name</label>
                                                <input type="text" value="{{$item->name}}" name="name" class="form-control" placeholder="Work Category" autocomplete="off">
                                                @if($errors->has('name'))
